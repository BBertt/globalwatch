const DonationItem = ({
  ...
  return (
    <div className="bg-[url('/assets/donation/donation_bg.jpg')] bg-cover bg-center min-h-screen flex justify-center items-center">
      <div className="bg-white bg-opacity-90 p-6 rounded-lg shadow-2xl w-[60rem] h-auto flex flex-col justify-between items-center border-2 border-blue-500">
        <div className="flex flex-col justify-center items-center">
          ...
          <p className="text-2xl font-bold text-gray-600 text-center mb-4">
        ...
        <textarea
          onChange={(e) =>
            setUserDonation({ ...userDonation, notes: e.target.value })
          }
